...
ENV S3_UPLOAD_BUCKET=default
ENV S3_UPLOAD_HOSTNAME=mirea.ninja
ENV S3_UPLOAD_ENDPOINT_URL=https://mirea.ninja
ENV S3_UPLOAD_REGION=ru-central

ENV NEXT_PUBLIC_S3_UPLOAD_RESOURCE_FORMATS=.png
