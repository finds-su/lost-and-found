  ...
  return (
    <div className='hidden md:block'>
      <div className='ml-4 flex items-center md:ml-6'>
        <button type='button' className='p-1 text-gray-400 hover:text-white focus:outline-none'>
          ...
          <Dropdown
            ...
            label={
              <>
                ...
                <Avatar
                  className={
                    'flex max-w-xs items-center rounded-full bg-gray-800 text-sm text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800'
                  }
                  size='sm'
